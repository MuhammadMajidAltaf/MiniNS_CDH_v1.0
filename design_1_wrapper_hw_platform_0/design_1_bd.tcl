...
CONFIG.CONST_VAL {0} \
  ...
  connect_bd_net -net axi_gpio_9_gpio_io_o [get_bd_pins DFF_Integrator_0/clr] [get_bd_pins LPF_Integrator_0/clr] [get_bd_pins axi_gpio_9/gpio_io_o] [get_bd_pins c_shift_ram_5/D]
  ...
  connect_bd_net -net c_shift_ram_5_Q [get_bd_pins c_shift_ram_5/Q] [get_bd_pins gater_0/rst2]
